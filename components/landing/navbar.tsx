      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-background border-b border-border/50 shadow-lg p-4 flex flex-col gap-4 animate-fade-in-up">
          ...
          <div className="flex items-center justify-center gap-8 p-4 border-t border-border/50 mt-2">
            <a href="https://github.com/WatermelonCorp/watermelon-platform" className="text-muted-foreground hover:text-foreground"><StarCheck className="w-6 h-6" /></a>
            <a href="https://x.com/watermelonui" className="text-muted-foreground hover:text-foreground"><ChartArea className="w-6 h-6" /></a>
          </div>
