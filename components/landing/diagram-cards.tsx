            ...
            {diagrams.diagrams.map((diagram) => (
              <Link key={diagram.slug} href={`/d/${diagram.slug}`} className="block">
                <motion.div
                  ...
                  whileHover="hover"
                  className="group relative flex flex-col border border-white/10 bg-white/[0.02] transition-colors duration-500 ease-out hover:border-primary/30 hover:bg-primary/[0.03]"
                >
                  ...
                  <motion.div
                    className="absolute right-0 top-0 m-3 h-2 w-2 rounded-full border border-white/10 bg-white/5"
                    variants={{
                      hover: {
                        scale: 1.6,
