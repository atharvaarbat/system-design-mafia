  ...
  return (
    <svg className="pointer-events-none h-full w-full" viewBox="0 0 400 300" fill="none">
      ...
      <motion.path
        ...
        variants={{
          hover: { strokeOpacity: 0.55, fillOpacity: 0.06, transition: { duration: 0.55, ease: easePremium } },
        }}
      />
        ...
        return (
          <motion.g key={`port-${i}`}>
            <motion.line
              ...
              variants={{
                hover: { strokeOpacity: 0.35, transition: { duration: 0.4, delay: i * 0.04, ease: easePremium } },
              }}
            />
            <motion.rect
              ...
              fill="var(--color-primary)" fillOpacity={0.02}
              variants={{
                hover: { strokeOpacity: 0.55, fillOpacity: 0.08, transition: { duration: 0.4, delay: i * 0.04, ease: easePremium } },
              }}
            />
            <motion.circle
              cx={extX} cy={extY} r="2"
