...
export function Dock({
  ...
  return (
    <motion.div
      ref={dockRef}
      className={cn(
        "relative rounded-xl flex items-end overflow-visible border border-foreground/[0.08] bg-background/80 px-2 py-2 shadow-none hover:shadow-[0_0_0_1px_rgba(0,0,0,0.02),0_2px_8px_rgba(0,0,0,0.04),0_8px_24px_rgba(0,0,0,0.06)] transition-shadow duration-200 backdrop-blur-xl",
        className,
      )}
      ...
      {!alwaysShowLabels && (
        <AnimatePresence>
          {hoveredIndex !== null && (
            ...
            >
              <span className="rounded-full border border-foreground/10 bg-background px-2 py-1 text-xs font-medium text-foreground shadow-sm whitespace-nowrap">
